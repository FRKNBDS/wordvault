  ...
  if (mode==="userPass" && selectedUser) return (
    <div className="auth-bg">
      ...
      <div className="auth-form" style={{width:"100%",maxWidth:320}}>
        <div className="field"><label>{lang==="en"?"PASSWORD":"ŞİFRE"}</label><input type="password" placeholder="••••••" value={userPass} onChange={e=>setUserPass(e.target.value)} onKeyDown={e=>{if(e.key==="Enter"){if(selectedUser.passwordHash===await hashPassword(userPass)){onLogin(selectedUser);}else{setError(lang==="en"?"Incorrect password.":"Şifre hatalı.");}}}} autoFocus /></div>
